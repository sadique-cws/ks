<nav class='navbar navbar-expand-lg navbar-dark bg-dark'>
    <div class="container">
        <div class="navbar-nav">
            <a href="<?= base_url('admin/index');?>" class="nav-item nav-link">Dashboard</a>
            <a href="<?= base_url('admin/products');?>" class="nav-item nav-link">Products</a>
            <a href="<?= base_url('admin/categories');?>" class="nav-item nav-link">Categories</a>
